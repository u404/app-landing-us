...
export default {
  ...
  methods: {
    rediectDownload() {
      console.log(QUERY.uriDownload || this.$i18n._("iosLink"))
...
<template>
  <div class="universal" v-if="inWeixin">
    <div class="top-guide">· {{$i18n._('已安装移动电影院')}}：</div>
    <div
      class="bottom-guide"
      :style="`background: url(${$i18n._('topGuideBj')}) no-repeat top center/contain `"
    >
      · {{$i18n._('未安装移动电影院')}}：
      <div
